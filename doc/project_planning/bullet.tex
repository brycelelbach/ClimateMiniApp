%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Bryce's scary code to make itemize simpler; you don't want to know how this
% works, but it lets you write:
%
% + Foo
%   + Bar
%
...
% \end{itemize}
%
% This helped me stay sane while studying for my optimization theory final.
