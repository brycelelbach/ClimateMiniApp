      ...
      if (fab1(iv, 0) != testVal)
        {
          if (verbose)
            {
              pout() << "  ForAllXBPencil test FAILED at " << iv << std::endl;
            }
          return_code += 1;
        }
    }
      ...
      if (fab1(iv, 0) != testVal)
        {
          if (verbose)
            {
              pout() << "  ForAllXBNNnoindx test FAILED at " << iv << std::endl;
            }
          return_code += 1;
        }
    }
      ...
      if (fab1(iv, 0) != testVal)
        {
          if (verbose)
            {
              pout() << "  ForAllXBNN test FAILED at " << iv << std::endl;
            }
          return_code += 1;
        }
    }
  ...
  if (sum != numPts*testVal)
    {
      if (verbose)
        {
          pout() << "  ForAllXCBNN test FAILED!" << std::endl;
        }
      return_code += 1;
    }
  ...
  if (fabStatus != 0)
    {
      if (verbose)
        {
          pout() << "  Fab-internal macro test FAILED!" << std::endl;
        }
      return_code += 100;
    }
      ...
      if (this->operator()(iv,0) != testVal)
        {
          if (a_verbose)
            {
              pout() << "  ForAllThisBNN test FAILED at " << iv << "!" << std::endl;
            }
          status += 1;
        }
    }
  ...
  if ( thisSum > tolerance)
    {
      if (a_verbose)
        {
          pout() << "  ForAllThisCBNN test FAILED! " << std::endl;
        }
      status += 1;
    }
  ...
  if ( thisSum > tolerance)
    {
      if (a_verbose)
        {
          pout() << "  ForAllThisCBNNXC test FAILED! " << std::endl;
        }
      status += 1;
    }
  ...
  if ( thisSum > tolerance)
    {
      if (a_verbose)
        {
          pout() << "  ForAllThisCPencil test FAILED! " << std::endl;
        }
      status += 1;
    }
