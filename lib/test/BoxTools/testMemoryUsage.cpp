...
int main(int argc, char* argv[])
{
  ...
  if ( verbose ) pout() << indent2 << "Beginning " << pgmname << " ..." << std::endl;
...
int testMU(void)
{
  ...
  pout() << " mega=" << mega << " (mega+1)*(mega+1)*(mega+1)=" << (mega+1)*(mega+1)*(mega+1) << std::endl;
  ...
  pout() << "Num baseLevelBoxes=" << baseLevelBoxes.size() << std::endl;
