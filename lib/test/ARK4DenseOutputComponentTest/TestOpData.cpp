...
void
TestOpData::define(/// box layout at this level
...
void
TestOpData::define(const TestOpData& a_state)
{
...
void
TestOpData::copy(const TestOpData& a_state)
{
  const LevelData<FArrayBox>& srcData = a_state.data();
